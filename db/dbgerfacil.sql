...
-- Copiando dados para a tabela dbgerfacil.tbavaliacoes: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela dbgerfacil.tbestado: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela dbgerfacil.tbeventos: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela dbgerfacil.tbusuarios_tbeventos: ~15 rows (aproximadamente)
